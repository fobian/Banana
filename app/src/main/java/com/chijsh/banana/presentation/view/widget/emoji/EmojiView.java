    ...
    private void init() {
        ...
        for (int i = 0; ; i++) {
            if (i >= Emoji.data.length) {
                ...
                localLinearLayout.setOrientation(HORIZONTAL);//TODO
                ...
                localTextView.setText(getContext().getResources().getString(R.string.no_recent));
